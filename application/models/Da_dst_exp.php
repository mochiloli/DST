<?php class Da_dst_exp extends MY_Model {
	public $exp_id;
	public $exp_topic;
	public $exp_content;
	public $exp_image;
	...
	public function inserts() {
		$this->db->set('exp_id', $this->exp_id);
		$this->db->set('exp_topic', $this->exp_topic);
		$this->db->set('exp_content', $this->exp_content);
$this->db->set('exp_image', $this->exp_image);
...
$this->db->from('duangsettee_dst_exp'); return $this->db->insert(); }
public function inserts_array($data=null) {
			...
			public function updates_array($data=null,$key=null) {
				return $this->db->update('duangsettee_dst_exp', $data, $key);
			}
			public function updates() {
				...
				$this->db->set('og_image', $this->og_image);
				$this->db->from('duangsettee_dst_exp');
		$this->db->where('exp_id', $this->exp_id);
