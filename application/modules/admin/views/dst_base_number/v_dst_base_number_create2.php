	...
	<div class="col-md-12">
        ...
        ?>  <div class="row">
            <div class="col-lg-6 form-group">
                <label class="col-lg-12 control-label" >หลักที่ </label>  
                <div class="col-lg-12">
                    <input name="base_number" value="<?PHP if(!empty($dst_base_number[0]->base_number)) echo $dst_base_number[0]->base_number;?>" type="text" placeholder="Base number" class="form-control" >
                </div>
            </div></div>
        <div class="row">
            <div class="col-lg-6 form-group">
